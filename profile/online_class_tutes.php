	...
	<div class="wrapper">
		<div class="sa4d25">
			<div class="container-fluid">
				<div class="row">
				<div class="col-lg-12">
				<h4 class="item_title">Download Paid Class Tutes</h4>
				<hr>
				</div>
				<div class="col-lg-12">
...
$tute_qury=mysqli_query($conn,"SELECT * FROM lmsclasstute WHERE subject IN ($sub_array_join) and ctype='Online Class' and status='1' and add_date BETWEEN '$s_month' and '$e_month' and subject='$fsubject'");
...
$lmsck_payment=mysqli_query($conn,"SELECT * FROM lmspayment WHERE userID='$_SESSION[reid]' and pay_sub_id='$tute_resalt[subject]' and status='1' and pay_month='$vmonth'");	
...
$tute_qury=mysqli_query($conn,"SELECT * FROM lmsclasstute WHERE subject IN ($sub_array_join) and ctype='Online Class' and status='1'");
while($tute_resalt=mysqli_fetch_array($tute_qury)){
